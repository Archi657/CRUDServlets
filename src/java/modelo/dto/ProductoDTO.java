...
public class ProductoDTO implements Serializable {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 67 * hash + this.id_prod;
        hash = 67 * hash + Objects.hashCode(this.nombre_prod);
        hash = 67 * hash + Objects.hashCode(this.descripcion_prod);
        hash = 67 * hash + this.und;
        hash = 67 * hash + (int) (this.valor ^ (this.valor >>> 32));
        return hash;
    }
